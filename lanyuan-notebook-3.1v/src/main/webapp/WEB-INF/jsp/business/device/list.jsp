...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/business/device/list.js"></script>
		...
		<form class="form-inline" role="form" id="searchForm"
			...
			<div class="form-group">
				<label class="control-label"> <span
					...
					<input class="input-medium ui-autocomplete-input" id="deviceName" name="deviceFormMap.deviceName">
			</div>
			...
			<a href="javascript:grid.exportData('/device/export.shtml')" class="btn btn-info" id="search">导出excel</a>
		</form>
	</div>
