            ...
            border=0>
              ...
              <TR>
                <TD width=155><IMG height=140 
                  src="images/logo1.jpg" width=155 useMap=#Map 
                  border=0></TD>
                <TD vAlign=top align=left width=214><TABLE cellSpacing=0 cellPadding=0 width=167 border=0>
                    <TBODY>
                    
                    <TR>
                      <TD vAlign=bottom width=167 height=30>云警管理后台登录</TD>
                    </TR>
                    <TR>
                        ...
                        align=center border=0>
                          <form action="<%=request.getContextPath()%>/login.html" method="post">
                            ...
                            width=43></DIV></TD>
                              ...
                              type=password size=15 name="j_password"></TD>
                              </TR>
                              <TR>
                                <TD vAlign=center colSpan=2 height=25><DIV align=center>
                                 <INPUT type=image src="images/b_login.gif" name=denglu onclick="javascript:checkValue();">
                                <!-- <input type="submit" value="登录"/> 
                                <IMG style="CURSOR: hand" onclick=document.form1.reset() height=21 src="images/b_clean.gif" width=73> </DIV></TD>
                                -->                                  
...
<MAP name=Map>
  <AREA shape=CIRCLE 
  target=_blank coords=77,67,57 href="http://sc.xueit.com/">
</MAP>
</BODY>
