package com.caiyi.financial.jzadmin.plugin;
...
import com.caiyi.financial.jzadmin.annotation.TableSeg;
...
public class PagePlugin implements Interceptor {
  ...
  private static String removeOrderBys(String toSql) {  
    ...
    public static StringBuilder buildPageSqlForOracle(String sql, PageView page) {
        StringBuilder pageSql = new StringBuilder(100);
        String beginrow = String.valueOf((page.getPageNow()-1) * page.getPageSize() +1);
