package com.caiyi.financial.jzadmin.logAop;
...
import com.caiyi.financial.jzadmin.entity.LogFormMap;
import com.caiyi.financial.jzadmin.mapper.LogMapper;
...
public  class LogAopAction {
    //本地异常日志记录对象
     ...
     //Controller层切点
    @Pointcut("@annotation(com.caiyi.financial.jzadmin.annotation.SystemLog)")
