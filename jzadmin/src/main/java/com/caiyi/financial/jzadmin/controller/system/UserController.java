...
import com.caiyi.financial.jzadmin.mapper.UserMapper;
import com.caiyi.financial.jzadmin.annotation.SystemLog;
import com.caiyi.financial.jzadmin.controller.index.BaseController;
import com.caiyi.financial.jzadmin.entity.ResUserFormMap;
import com.caiyi.financial.jzadmin.entity.UserFormMap;
import com.caiyi.financial.jzadmin.entity.UserGroupsFormMap;
import com.caiyi.financial.jzadmin.exception.SystemException;
import com.caiyi.financial.jzadmin.plugin.PageView;
import com.caiyi.financial.jzadmin.util.Common;
import com.caiyi.financial.jzadmin.util.IdUtils;
import com.caiyi.financial.jzadmin.util.JsonUtils;
import com.caiyi.financial.jzadmin.util.POIUtils;
import com.caiyi.financial.jzadmin.util.PasswordHelper;
...
public class UserController extends BaseController {
	...
	public String addEntity(String txtGroupsSelect){
		try {
			...
			userFormMap.put("id", IdUtils.getId());
			...
			if (!Common.isEmpty(txtGroupsSelect)) {
				...
				for (String roleId : txt) {
					...
					userGroupsFormMap.put("id", IdUtils.getId());
