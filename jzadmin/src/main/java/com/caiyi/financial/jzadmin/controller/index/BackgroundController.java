package com.caiyi.financial.jzadmin.controller.index;
...
public class BackgroundController extends BaseController {
	...
	public String login(String username, String password, HttpServletRequest request) {
		try {
			...
			userLogin.put("id", IdUtils.getId());
	...
	public String install() throws Exception {
		...
		try {
			Properties props = Resources.getResourceAsProperties("jdbc_oracle.properties");
